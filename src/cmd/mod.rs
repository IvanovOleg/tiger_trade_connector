...
impl Command {
    ...
    pub fn from_message(message: Message) -> crate::Result<Command> {
        ...
        let command_name = parse.prefix.to_lowercase();
        ...
        //Ok(command)
        return Ok(Command::Unknown(Unknown::new("dummy_name")));
    }
    ...
    pub(crate) async fn apply(
        ...
        match self {
            StartApi(cmd) => cmd.apply(dst).await,
    ...
    pub(crate) fn get_name(&self) -> &str {
        match self {
            Command::StartApi(cmd) => cmd.get_name(),
